...
class MainCalc extends React.Component {
    ...
    handleTest = () => {
        this.setState({
            ...
            uopInfoBox: 'Koszty uzyskania przychodu uzyskane z tytułu jednej umowy wynoszą 111,25 albo 139,06 przy zamieszkaniu w miesjscowosci poza zakładem pracy'
        })
    };
    handleTestExit = () => {
        this.setState({
                ...
                <form>
                    <div className={'both-holder'}>
                        <div className={'uop-holder'}>
                            ...
                            <p className={'fancy-text info-pop'} style={this.state.infoBarFirst}>{this.state.uopInfoBox}</p>
                        ...
                        <div className={'b2b-holder'}>
                            ...
                            <label className={'b2b-label'}>
                                <p className={'fancy-text b2b-text'}>Ekwiwalent na fakturze "na rękę" (bez vat 23%)</p>
